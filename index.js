...
const modalMessageList = [
  { "number": 1, "message": "12월, 행복이 가득찬 마음으로 채워져 있는 시간!" },
  { "number": 2, "message": "모두에게 행복한 크리스마스가 되도록!" },
  { "number": 3, "message": "다 같이 즐겁게 보내는 3일, 행복이 가득합니다!" },
  ...
  { "number": 13, "message": "행복의 파도가 모두에게 찾아오는 특별한 12월!" },
  ...
  { "number": 17, "message": "크리스마스 이브까지 일주일 남았어!" },
  { "number": 18, "message": "오늘 크리스마스 기념으로 핫초코 어때?" },
  { "number": 19, "message": "크리스마스와 함께 찾아오는 새해도 잊지 말아줘!" },
  { "number": 20, "message": "크리스마스는 언제나 설레지." },
  { "number": 21, "message": "지인들에게 편지 보내는 것 잊지 마!" },
  { "number": 22, "message": "이제 점점 크리스마스의 기운이 느껴지네요!." },
  { "number": 23, "message": "다 함께하는 24일, 행복한 느낌이 가득할 거예요." },
  { "number": 24, "message": "두근두근!! 내일은 크리스마스❤" }
];
